...
```
Den estimere ikke rigtigt når vi har followup...
...
set.seed(9457)
try1 <- sys_invest(N = 100, eff_A_D = -0.5)
try2 <- sys_invest(N = 100, eff_L_A = 2, eff_L_D = 2, eff_A_D = -0.5)
# TODO: Af en eller anden grund går det galt her?
# timefix = FALSE lader os fitte modellerne, men de giver ikke gode estimater...
try3 <- sys_invest(N = 100, eff_L_A = 1, eff_L_D = 2, eff_A_D = -0.3)


data1 <- sim_data_setting1(N = 20000, eta = rep(0.05,4), nu = rep(1.02, 4),
                           beta_L_A = 1, beta_L_D = 2, beta_A_D = -0.3)
