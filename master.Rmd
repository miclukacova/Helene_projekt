...
This corresponds to using the general function `vec_sim_event_data` in the following way.
...
The function `sim_surv_data` simulates survival data. It is a wrapper of the function `vec_sim_event_data`.
