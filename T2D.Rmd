...
estimator2 <- function(data, N) {
    ...
    return(c(preds$`L0=50, L1=0, A0=0`, preds$`L0=50, L1=0, A0=1`))
}
...
### When there is no effect of drug on death
...
```
A little bit higher probability of death under interventions. 
