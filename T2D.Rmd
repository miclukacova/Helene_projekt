...
```{r}
data0 <- sim_data_setting2(N = 5 * 10^4, beta_L_D = 1, beta_A0_D = -0.1,
                           beta_L0_L = 1, beta_A0_L = 0)
data0.5 <- sim_data_setting2(N = 5 * 10^4, beta_L_D = 1, beta_A0_D = -0.1,
                           beta_L0_L = 1, beta_A0_L = -0.5)
data1 <- sim_data_setting2(N = 5 * 10^4, beta_L_D = 1, beta_A0_D = -0.1,
...
nrow(T2D_peeps0[Time < 2 & Delta == 1 & A0 == 1]) / length(unique(T2D_peeps0[A0 == 1]$ID))
nrow(T2D_peeps0[Time < 2 & Delta == 1 & A0 == 0]) / length(unique(T2D_peeps0[A0 == 0]$ID))

nrow(T2D_peeps0.5[Time < 2 & Delta == 1 & A0 == 1]) / length(unique(T2D_peeps0.5[A0 == 1]$ID))
nrow(T2D_peeps0.5[Time < 2 & Delta == 1 & A0 == 0]) / length(unique(T2D_peeps0.5[A0 == 0]$ID))

nrow(T2D_peeps1[Time < 2 & Delta == 1 & A0 == 1]) / length(unique(T2D_peeps1[A0 == 1]$ID))
nrow(T2D_peeps1[Time < 2 & Delta == 1 & A0 == 0]) / length(unique(T2D_peeps1[A0 == 0]$ID))
```
