...
```{r}
beta_L0_L <- c(1.5, 1.3, 2, 1)
beta_A0_L <- c(-1, -1.3, -2.5, -1.2)
beta_L_D <- c(0.9, 1, 1, 0.8)
beta_L0_D <- c(0.6, 0.7, 0.3, 0.6)
...
```{r}
tau <- 1
surv_prop1 <- numeric(4)
surv_prop0 <- numeric(4)

for(i in 1:4){
  # T2D events
  T2D_events <- data_list[[i]][Delta == 3]
