...
my_hist <- function(data0, data0.5, data1) {
  ...
  ggplot(T2D_events0)+
    geom_histogram(aes(x = L0), bins = 15)+
    facet_grid(~A0),
...
```{r}
data0_c <- sim_data_setting2(N = N, beta_L_D = 1, beta_A0_D = -0.3,
                           beta_L0_L = 0.7, beta_A0_L = 0,
                           cens = 0, beta_L0_D = 1.5)
data0.5_c <- sim_data_setting2(N = N, beta_L_D = 1, beta_A0_D = -0.3,
                           beta_L0_L = 0.7, beta_A0_L = -0.5,
                           cens = 0, beta_L0_D = 1.5)
data1_c <- sim_data_setting2(N = N, beta_L_D = 1, beta_A0_D = -0.3,
