...
- The effect of the baseline covariate, the effect of $k$ (the number of the event) and the effect of treatment $A$ on the different intensities: $\beta^x \in \mathbb{R}^{3}$ where $x \in X$. The input `beta` should be given as a matrix where each column corresponds to an event $x \in X$.
...
sur_sim <- function(N,                      # Number of individuals
  ...
  # Simulation
  res <- tibble(ID = numeric(), L0 = numeric(), Time = numeric(), Delta = numeric(), A = numeric())
